 ...
 */
public class tGameWonWindow extends Window {
    ...
    public tGameWonWindow(int eGameId,String eUserLog,TabSheet eGameMenuTabSheet,tGameRunningLayout eGameRunningLayout){
        ...
        this.setIcon(VaadinIcons.TROPHY);
        this.setCaption(" Поздравляем, Вы выиграли.");
        ...
        CloseButton.addClickListener(new Button.ClickListener() {
            ...
            public void buttonClick(Button.ClickEvent clickEvent) {
                UI.getCurrent().removeWindow((tGameWonWindow) clickEvent.getButton().getData());
            }
        });
